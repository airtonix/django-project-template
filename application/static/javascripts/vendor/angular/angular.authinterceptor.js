...
(function () {
  ...
  .config(['$httpProvider', function($httpProvider) {
    var interceptor = ['$rootScope', '$q', 'httpBuffer', '$log', function($rootScope, $q, httpBuffer, $log) {
      function success(response) {
        $log.info("http-auth-interceptor.success", response)
        return response;
      }

      function error(response) {
        $log.info("http-auth-interceptor.error", response)

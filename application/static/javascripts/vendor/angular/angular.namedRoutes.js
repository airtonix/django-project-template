angular.module("zj.namedRoutes", [])
    ...
    .directive('namedUrlTag', function($log, $rootScope, $NamedRouteService){
            return {
                restrict: "A",
                link: function(scope, element, attributes){
                    $rootScope.$on('$routeChangeSuccess', function(angularEvent, current, previous){
                        element.attr( attributes['namedUrlTag']||'id', current.$$route.name);
                        })
    ...
    .directive('namedUrl', function($log, $NamedRouteService){
            ...
            return {
                restrict: "AC",
                link: function(scope, element, attributes){
                    var url = $NamedRouteService.reverse(attributes.namedUrl, attributes)
